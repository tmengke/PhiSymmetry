...
TFile *fila = new TFile (ctit);
  ...
  TH2F* hHPDc = new TH2F("hHPDc","corr  HEM depth 2",14,-29.5,-15.5,72,0,72);
  hHPDc->Sumw2();
  hmapPc->Sumw2();
  ...
  for (int ii=0;ii<14;ii++) {
    ...
    if(abs(ieta)>=21 && abs(ieta)<30) {
      // if(iphi%4==3 && abs(ieta)%2==1 && abs(ieta)!=29) index++;
      // if(iphi%4==3 && abs(ieta)%2==1 && abs(ieta)!=29) index++;
      if(iphi%4==3 && abs(ieta)%2==1) index++;                                                                              
      if(iphi%4==3 && abs(ieta)%2==1) index++;                                                                                
      if(iphi%4==1 && abs(ieta)%2==0) index++;   
      if(iphi%4==1 && abs(ieta)%2==0) index++;
	...
	if (fabs(dcorrL)>0.001) { 
	  ...
	  //cout<<"check error "<<corrL*drLP<<endl;
  ...
  FILE *ft1;
  sprintf(ctit,"TEST/HEM2.txt",ftit,((int) Ethr1),((int) Ethr2));
  ...
  cout <<"check error -3- = "<<hHPDc->GetBinError(14,5)<<"   "<<hHPDc->GetBinError(14,6)<<endl;
